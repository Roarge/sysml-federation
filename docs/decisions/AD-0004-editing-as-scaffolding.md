...
## Sources
The repository README, "Placeholders" and "The pipeline example". [The use cases](../stories/README.md) for the editable set and the criteria on invalid input, and [The demo as it shipped](../articles/10-the-demo-as-it-shipped.md) for the three mutations and the refusals as they ship. AD-0003 for why there is no repository to write to.
