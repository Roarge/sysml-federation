...
[Planning the build](../articles/08-planning-the-build.md) for the figures and for what kind of number they are, and [The demo being built](../articles/10-the-demo-being-built.md) for the counts as the system ships.
