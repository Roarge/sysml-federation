...
func (ec *executionContext) resolveEntity(
	...
	case "Part":
		...
		case "findPartByID":
			...
			err = ec.PopulatePartRequires(ctx, entity, rep)
			if err != nil {
				return nil, fmt.Errorf(`populating requires for Entity "Part": %w`, err)
			}
			return entity, nil
		}
	case "Requirement":
		...
		case "findRequirementByID":
			...
			err = ec.PopulateRequirementRequires(ctx, entity, rep)
			if err != nil {
				return nil, fmt.Errorf(`populating requires for Entity "Requirement": %w`, err)
			}
			return entity, nil
		}
